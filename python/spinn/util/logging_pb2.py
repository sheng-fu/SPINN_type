...
_SPINNHEADER_COMMANDLINEFLAG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='logging.SpinnHeader.CommandLineFlag.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='logging.SpinnHeader.CommandLineFlag.value',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_EVALDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='eval_class_accuracy',
            full_name='logging.EvalData.eval_class_accuracy',
            index=0,
            number=2,
            type=2,
            cpp_type=6,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='eval_transition_accuracy',
            full_name='logging.EvalData.eval_transition_accuracy',
            index=1,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='filename',
            full_name='logging.EvalData.filename',
            index=2,
            number=4,
            type=9,
            cpp_type=9,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='time_per_token_seconds',
            full_name='logging.EvalData.time_per_token_seconds',
            index=3,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='report_path',
            full_name='logging.EvalData.report_path',
            index=4,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='invalid',
            full_name='logging.EvalData.invalid',
            index=5,
            number=7,
            type=2,
            cpp_type=6,
...
_SPINNENTRY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='root_label', full_name='logging.SpinnEntry.root_label', index=11,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='policy_cost', full_name='logging.SpinnEntry.policy_cost', index=12,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='value_cost', full_name='logging.SpinnEntry.value_cost', index=13,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='mean_adv_mean', full_name='logging.SpinnEntry.mean_adv_mean', index=14,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='mean_adv_mean_magnitude', full_name='logging.SpinnEntry.mean_adv_mean_magnitude', index=15,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='mean_adv_var', full_name='logging.SpinnEntry.mean_adv_var', index=16,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='mean_adv_var_magnitude', full_name='logging.SpinnEntry.mean_adv_var_magnitude', index=17,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='epsilon', full_name='logging.SpinnEntry.epsilon', index=18,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='temperature', full_name='logging.SpinnEntry.temperature', index=19,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='evaluation', full_name='logging.SpinnEntry.evaluation', index=20,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='rl_sampling', full_name='logging.SpinnEntry.rl_sampling', index=21,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='checkpoint', full_name='logging.SpinnEntry.checkpoint', index=22,
...
_EVALUATIONREPORT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='batches',
            full_name='logging.EvaluationReport.batches',
            index=0,
            number=1,
            type=11,
            cpp_type=10,

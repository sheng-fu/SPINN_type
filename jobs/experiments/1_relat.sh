...
DATA=relational
DEVAL=../../spinn/python/spinn/data/dual_arithmetic/relational5_1k.tsv
DTRAIN=../../spinn/python/spinn/data/dual_arithmetic/relational5_10k.tsv
LRs=(0.0001)
RWs=(1.0 0.1 0.001)
GPU=0
STEPS=100000
...
do
    ...
    do
        python -m spinn.models.fat_classifier \
            ...
            --experiment_name $DATA-lr.$LR-rlw.$RW
    done
done
